...
:
    myAdvectiveFvPatchField<Type>(p, iF),
    psiName_("thermo:psi"),
    gamma_(0.0)
{}
...
:
    myAdvectiveFvPatchField<Type>(ptf, p, iF, mapper),
...
:
    myAdvectiveFvPatchField<Type>(p, iF, dict),
...
:
    myAdvectiveFvPatchField<Type>(ptpsf),
...
:
    myAdvectiveFvPatchField<Type>(ptpsf, iF),
    psiName_(ptpsf.psiName_),
    gamma_(ptpsf.gamma_)
{}
